...
ACCEPT_STATES = {
    ...
    "ACCEPT_PLUS", "ACCEPT_MINUS", "ACCEPT_STAR", "ACCEPT_DIV",
    "ACCEPT_ASSIGN", "ACCEPT_EQ",
    "ACCEPT_LT", "ACCEPT_LE", "ACCEPT_GT", "ACCEPT_GE",
    "ACCEPT_LPAREN", "ACCEPT_RPAREN",
    "ACCEPT_LBRACE", "ACCEPT_RBRACE",
    "ACCEPT_SEMI", "ACCEPT_COMMA",
    "COMMENT_END", "COMMENT_M_END","ERROR",
}
